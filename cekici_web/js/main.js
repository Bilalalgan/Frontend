...
(function(html) {
   ...
   const ssPreloader = function() {
        ...
        // Sayfa tamamen yüklenmeden önce de preloader'ı kaldırma
        window.addEventListener('load', function() {
            html.classList.remove('ss-preload');
            html.classList.add('ss-loaded');

            // Daha hızlı geçiş süresi için transitionend yerine setTimeout kullanabiliriz
            setTimeout(() => {
                siteBody.classList.add('ss-show');
                preloader.style.display = 'none';
            }, 200); // 500ms süresini daha da kısaltabilirsin
        });
    };
