                ...
                <main class="col-lg-7">
                    <article>
                        ...
                        <dl class="row border-bottom">
                            <dt class="col-sm-3">Yenileme Hızı (Hz)</dt>
                            <dd class="col-sm-9"><?php echo $res->monitor_hz; ?> Hz</dd>
                            <dt class="col-sm-3">Çözünürlük (max)</dt>
                            <dd class="col-sm-9"><?php echo $res->resolution; ?> </dd>
                            <dt class="col-sm-3">Dahili Hoparlör</dt>
                            <dd class="col-sm-9"><?php 
                            if ($res->internal_speaker  != "false") {
                                echo "Var";
                            } else {
                                echo "Yok";
                            }
                            ?></dd>
                            <dt class="col-sm-3">Ekran Büyüklüğü (İnç)</dt>
                            <dd class="col-sm-9"><?php echo $res->screen_size; ?> inç</dd>
                            <dt class="col-sm-3">Tepki Süresi</dt>
                            <dd class="col-sm-9"><?php echo $res->reaction_time_ms; ?>  ms</dd>
