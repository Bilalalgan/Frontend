                ...
                <main class="col-lg-7">
                    <article>
                        ...
                        <dl class="row border-bottom">
                            ...
                            <dd class="col-sm-9"><?php echo $res->laptop_os; ?></dd>
                            <dt class="col-sm-3">İşlemci</dt>
                            <dd class="col-sm-9"><?php echo $res->laptop_cpu; ?></dd>
                            <dt class="col-sm-3">SSD Kapasitesi</dt>
                            <dd class="col-sm-9"><?php echo $res->laptop_ssd; ?> GB</dd>
                            <dt class="col-sm-3">Harddisk Kapasitesi</dt>
                            <dd class="col-sm-9"><?php echo $res->laptop_hdd; ?> GB</dd>
                            <dt class="col-sm-3">Ram (Sistem Belleği)</dt>
                            <dd class="col-sm-9"><?php echo $res->laptop_ram; ?> GB</dd>
                            <dt class="col-sm-3">Ekran Boyutu</dt>
                            <dd class="col-sm-9"><?php echo $res->laptop_screen_size; ?> inç</dd>
                            <dt class="col-sm-3">Ekran Kartı Modeli</dt>
                            <dd class="col-sm-9"><?php echo $res->laptop_gpu; ?></dd>
