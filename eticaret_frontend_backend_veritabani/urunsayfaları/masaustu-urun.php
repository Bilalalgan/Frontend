                ...
                <main class="col-lg-7">
                    <article>
                        ...
                        <dl class="row border-bottom">
                            <dt class="col-sm-3">İşletim Sistemi</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_os; ?></dd>
                            <dt class="col-sm-3">İşlemci</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_cpu; ?></dd>
                            <dt class="col-sm-3">SSD Kapasitesi</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_ssd; ?> GB</dd>
                            <dt class="col-sm-3">Harddisk Kapasitesi</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_hdd; ?> GB</dd>
                            <dt class="col-sm-3">Ram (Sistem Belleği)</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_ram; ?> GB</dd>
                            <dt class="col-sm-3">Ekran Kartı Tipi</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_gpu_type; ?></dd>
                            <dt class="col-sm-3">Ekran Kartı Modeli</dt>
                            <dd class="col-sm-9"><?php echo $res->masaustu_gpu; ?></dd>
