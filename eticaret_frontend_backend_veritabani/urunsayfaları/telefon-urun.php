                ...
                <main class="col-lg-7">
                    <article>
                        ...
                        <dl class="row border-bottom">
                            ...
                            <dd class="col-sm-9"><?php echo $res->telefon_marka; ?></dd>
                            <dt class="col-sm-3">Model</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_model; ?></dd>
                            <dt class="col-sm-3">Dahili Hafıza</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_hafiza; ?> GB</dd>
                            <dt class="col-sm-3">RAM Kapasitesi</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_ram; ?> GB</dd>
                            <dt class="col-sm-3">Kamera Çözünürlüğü</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_kamera_cozunurluk_arka; ?></dd>
                            <dt class="col-sm-3">Ekran Boyutu</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_ekran_boyut; ?> inç</dd>
                            <dt class="col-sm-3">Pil Gücü</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_pil; ?> mAh</dd>
                            <dt class="col-sm-3">Ön (Selfie) Kamera</dt>
                            <dd class="col-sm-9"><?php echo $res->telefon_kamera_cozunurluk_on; ?> MP</dd>
                        </dl>
                        <div class="buttons">
