	...
	<div class = "container-fluid" style="min-height:77.6vh;>
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Odalar / Oda Ekle</div>
				<br />
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "room_type">
								...
								<option value = "Standard">Standart İki Kişilik</option>
								<option value = "Superior">Standart Çift Kişilik</option>
								<option value = "Super Deluxe">Süper Çift Kişilik</option>
								<option value = "Jr. Suite">Süit</option>
								<option value = "Executive Suite">Süper Süit</option>
							</select>
						</div>
						<div class = "form-group">
							<label>Fiyat</label>
						...
						<div class = "form-group">
							...
							<div id = "preview" style = "width:150px; height :150px; border:1px solid #000;">
								<center id = "lbl">[Fotoğraf]</center>
							</div>
							<input type = "file" required = "required" id = "photo" name = "photo" />
						</div>
						<br />
						<div class = "form-group">
							<button name = "add_room" class = "btn btn-info form-control"><i class = "glyphicon glyphicon-save"></i> Kaydedildi</button>
						</div>
					</form>
