	...
	<div class = "row mt-5 border py-5" style = "padding-left: 8vh;">
		...
		<div class="col-4 py-3">
			<div class="card ms-5" style="width: 45rem;">
				<img src = "images/gallery/1.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-3">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/2.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-3">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/3.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card ms-5" style="width: 45rem;">
				<img src = "images/gallery/4.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/5.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/6.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card ms-5" style="width: 45rem;">
				<img src = "images/gallery/7.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/8.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/9.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card ms-5" style="width: 45rem;">
				<img src = "images/gallery/10.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/11.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
		<div class="col-4 py-5">
			<div class="card" style="width: 50rem;">
				<img src = "images/gallery/12.jpg" height = "400px" class="card-img-top" alt="...">
			</div>
		</div>
	</div>
