                ...
                <main class="col-lg-7">
                    <article>
                        ...
                        <dl class="row border-bottom">
                            ...
                            <dt class="col-sm-3">Adımsayar</dt>
                            <dd class="col-sm-9"><?php if($res->saat_adim  != "false"){echo "Var";}else{echo "Yok";} ?></dd>
                            <dt class="col-sm-3">Kamera</dt>
                            <dd class="col-sm-9"><?php if($res->saat_kamera  != "false"){echo "Var";}else{echo "Yok";} ?></dd>
                            <dt class="col-sm-3">Su Geçirmezlik</dt>
                            <dd class="col-sm-9"><?php if($res->saat_su  != "false"){echo "Var";}else{echo "Yok";} ?></dd>
                            <dt class="col-sm-3">Uyku Takibi</dt>
                            <dd class="col-sm-9"><?php if($res->saat_uyku  != "false"){echo "Var";}else{echo "Yok";} ?></dd>
                            <dt class="col-sm-3">Sesli Görüşme</dt>
                            <dd class="col-sm-9"><?php if($res->saat_sesli  != "false"){echo "Var";}else{echo "Yok";} ?></dd>
                            <dt class="col-sm-3">Kalp Ritmi Ölçme</dt>
                            <dd class="col-sm-9"><?php if($res->saat_kalp  != "false"){echo "Var";}else{echo "Yok";} ?></dd>
                            <dt class="col-sm-3">GPS</dt>
                            <dd class="col-sm-9"><?php if($res->saat_gps != "false"){echo "Var";}else{echo "Yok";}?></dd>
                        </dl>
                        ...
                        <div class="buttons">
                            <a href="#" class="btn btn-warning" onclick="if (<?php if (isset($_SESSION['loggedin'])) {echo 1;} else {echo 0;}?> == 1) {sepete_ekle('<?php echo $_GET['urun_id']; ?>');location.reload()} else {location.href='../login.php'}">
                                ...
                                <?php 
                                    ...
                                    if (in_array(intval($_GET['urun_id']), $_SESSION['sepet'])) {
                            ...
                            <a href="#" class="btn btn-warning" onclick="if (<?php if (isset($_SESSION['loggedin'])) {echo 1;} else {echo 0;}?> == 1) {favorilere_ekle('<?php echo $_GET['urun_id']; ?>');location.reload()} else {location.href='../login.php'}">
                                <?php 
                                    if (isset($_SESSION['loggedin'])) {
                                        if (in_array(intval($_GET['urun_id']), $_SESSION['favoriler'])) {
