    ...
    <div class="container">
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <h2 class="admin-heading text-center">Aylık Kitap Ödünç Verme Raporu</h2>
            </div>
        </div>
        <div class="row">
            <div class="offset-md-4 col-md-4">
                <form class="yourform mb-5" action="" method="post">
                    ...
                    <input type="submit" class="btn btn-danger" name="search_month" value="Arama">
                </form>
            </div>
        </div>
        <?php
        if(isset($_POST['search_month']) && !empty($_POST['month'])){
          ...
          $sql = "SELECT kitap_odunc_verme.odunc_id,kitap_odunc_verme.odunc_adi,kitap_odunc_verme.odunc_kitap,kitap_odunc_verme.odunc_durum,
                  ...
                  WHERE DATE_FORMAT(kitap_odunc_verme.odunc_verme_tarihi,'%Y-%m') = '{$month}'
